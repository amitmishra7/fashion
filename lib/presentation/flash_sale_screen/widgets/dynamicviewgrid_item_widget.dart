    ...
    return Column(
      ...
      children: [
          ...
          child: Container(
            ...
            child: Stack(
              ...
              children: [
                Obx(
                  () => CustomImageView(
                    imagePath: dynamicviewgridItemModelObj.image!.value,
                    height: 171.v,
                    width: 155.h,
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Obx(
                            () => Text(
                              dynamicviewgridItemModelObj.title!.value,
        ...
        SizedBox(
          ...
          child: Obx(
            () => Text(
              dynamicviewgridItemModelObj.text!.value,
              maxLines: 2,
        ...
        Row(
          children: [
            Obx(
              () => Text(
                dynamicviewgridItemModelObj.price1!.value,
            ...
            Padding(
              ...
              child: Obx(
                () => Text(
                  dynamicviewgridItemModelObj.price2!.value,
