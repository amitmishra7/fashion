import '../voucher_added_screen/widgets/userprofile10_item_widget.dart';
...
class VoucherAddedScreen extends GetWidget<VoucherAddedController> {
  const VoucherAddedScreen({Key? key})
      : super(
          key: key,
        );
      ...
      child: Obx(
        () => ListView.separated(
          ...
          itemCount: controller
              .voucherAddedModelObj.value.userprofile10ItemList.value.length,
          itemBuilder: (context, index) {
            Userprofile10ItemModel model = controller
                .voucherAddedModelObj.value.userprofile10ItemList.value[index];
