...
class Userprofile10ItemWidget extends StatelessWidget {
  ...
  var controller = Get.find<VoucherAddedController>();
    ...
    return Row(
      ...
      children: [
            ...
            children: [
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Obx(
                    () => Text(
                      userprofile10ItemModelObj.group138Text!.value,
        ...
        Container(
          ...
          child: Obx(
            () => Text(
              userprofile10ItemModelObj.loremIpsumDolorText!.value,
              maxLines: 2,
        ...
        Padding(
          ...
          child: Obx(
            () => Text(
              userprofile10ItemModelObj.titleText!.value,
