import 'controller/choose_payment_method_2_cards_controller.dart';
import 'package:amit_s_application2/core/app_export.dart';
import 'package:amit_s_application2/widgets/custom_radio_button.dart';
import 'package:flutter/material.dart';

class ChoosePaymentMethod2CardsBottomsheet extends StatelessWidget {
  ChoosePaymentMethod2CardsBottomsheet(
    this.controller, {
    Key? key,
  }) : super(
          key: key,
  ...
  ChoosePaymentMethod2CardsController controller;

  @override
  Widget build(BuildContext context) {
    return _buildChoosePaymentRow();
  }

  /// Section Widget
  Widget _buildChoosePaymentRow() {
    return Container(
