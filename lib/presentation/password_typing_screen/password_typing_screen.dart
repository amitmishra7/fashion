...
class PasswordTypingScreen extends GetWidget<PasswordTypingController> {
  const PasswordTypingScreen({Key? key})
      : super(
          key: key,
        );
    ...
    return SafeArea(
      child: Scaffold(
        body: SizedBox(
          ...
          child: Column(
            children: [
              _buildPasswordTypingScreen(),
              SizedBox(height: 9.v),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  CustomImageView(
                    imagePath: ImageConstant.imgEllispse01,
                    height: 17.adaptSize,
                    width: 17.adaptSize,
                  ),
                  CustomImageView(
  ...
  /// Section Widget
  Widget _buildPasswordTypingScreen() {
    return SizedBox(
      height: 336.v,
      width: double.maxFinite,
      child: Stack(
