...
class ChatAgentIsTypingScreen extends GetWidget<ChatAgentIsTypingController> {
  const ChatAgentIsTypingScreen({Key? key})
      : super(
          key: key,
        );
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.fromLTRB(10.h, 3.v, 6.h, 2.v),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          SizedBox(
