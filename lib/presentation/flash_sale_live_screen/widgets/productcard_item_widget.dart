...
class ProductcardItemWidget extends StatelessWidget {
  ...
  var controller = Get.find<FlashSaleLiveController>();
    ...
    return Column(
      ...
      children: [
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Obx(
                            () => Text(
                              productcardItemModelObj.discountTitle!.value,
        ...
        SizedBox(
          ...
          child: Obx(
            () => Text(
              productcardItemModelObj.descriptionText!.value,
              maxLines: 2,
        ...
        Row(
          children: [
            Obx(
              () => Text(
                productcardItemModelObj.priceTitle1!.value,
            ...
            Padding(
              ...
              child: Obx(
                () => Text(
                  productcardItemModelObj.priceTitle2!.value,
