import '../chat_starting_question_one_screen/widgets/order_item_widget.dart';
...
class ChatStartingQuestionOneScreen
    extends GetWidget<ChatStartingQuestionOneController> {
  const ChatStartingQuestionOneScreen({Key? key})
      : super(
          key: key,
        );
                      ...
                      child: Obx(
                        () => Wrap(
                          ...
                          children: List<Widget>.generate(
                            controller.chatStartingQuestionOneModelObj.value
                                .orderItemList.value.length,
                            (index) {
                              OrderItemModel model = controller
                                  .chatStartingQuestionOneModelObj
                                  .value
                                  .orderItemList
                                  .value[index];
